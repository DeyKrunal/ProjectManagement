                            ...
                            <table class="table table-bordered table-striped js-basic-example dataTable table-hover m-b-0">
                                ...
                                <?php
                                    ...
                                    while($row=mysqli_fetch_array($res)) { ?>
                                        ...
                                        <td><img src="upload\<?php echo $row[4]; ?>" height=100 width=100></td>
                                        <td><a href="del.php?del=<?php echo $row[0]; ?>" onclick="return confirm('Are you sure you want to delete Record <?php echo $row[1]; ?>' );">
                                        <i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;Delete</a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <td><a href="add-students.php?upd=<?php echo $row[0]; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Edit</a></td></tr>
                                <?php 
                                    } 
                                    ?>
                                    <!-- <tr>
